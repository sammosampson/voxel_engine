...
pub fn build_play_schedule() -> Schedule {
    Schedule::builder()
        ...
        .flush()
        .add_system(terrain::initial_terrain_build_system())
        .flush()
        .add_system(terrain::reveal_terrain_system())
        .flush()
...
pub fn build_editor_schedule() -> Schedule {
    Schedule::builder()
        ...
        .add_thread_local(graph::build_editor_render_graph_for_chunks_system())
