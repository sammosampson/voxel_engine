...
#[system(for_each)]
pub fn build_editor_render_graph_for_measurements(measurement: &BlockPerformanceMeasurement, #[resource] graph: &mut EditorRenderGraph) {
    ...
    row.insert(EditorRenderGraphDataItem::CycleMeasurement, EditorRenderGraphData::Int { value: measurement.cycles });
    ...
    row.insert(EditorRenderGraphDataItem::HitMeasurement, EditorRenderGraphData::Int { value: measurement.hits });
