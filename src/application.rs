...
fn build_schedule() -> Schedule {
    Schedule::builder()
        ...
        .flush()
        .add_system(systems::world_entity_selection_effects_entities_system())
        ...
        .add_thread_local(systems::set_world_visibility_system())
        .add_thread_local(systems::set_render_style_system())
